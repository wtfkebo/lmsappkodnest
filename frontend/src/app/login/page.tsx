...
import { Mail, Lock, ArrowRight, Zap, Database, Activity, Code, Shield } from 'lucide-react';
...
export default function Login() {
  ...
  return (
    <div className="flex h-screen overflow-hidden text-foreground bg-background selection:bg-primary selection:text-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black flex-col justify-between p-24 overflow-hidden relative">
         ...
         <div className="relative z-10">
           <Link href="/" className="inline-flex items-center gap-6 group">
             <div className="w-12 h-12 bg-primary flex items-center justify-center rotate-45 group-hover:rotate-0 transition-all duration-700">
                <Code size={24} className="text-white -rotate-45 group-hover:rotate-0 transition-all" />
             </div>
             <span className="text-3xl font-black text-white tracking-[-0.1em] uppercase">KODLEARN / GR</span>
           </Link>
         </div>
         ...
         <div className="relative z-10">
            <h1 className="text-[8rem] font-black text-white mb-12 tracking-[-0.12em] uppercase leading-[0.8] mix-blend-difference">
               RESUME <br />
               <span className="text-primary italic">STUDY.</span>
            </h1>
            <p className="text-gray-400 max-w-xl font-bold uppercase tracking-[0.4em] text-[10px] leading-relaxed">
               Welcome back. Continue your learning journey and sharpen your skills.
            </p>
         </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-8 relative z-10 w-full lg:w-1/2">
        <Link href="/" className="absolute top-12 right-12 text-gray-600 hover:text-black transition-all text-[11px] font-black uppercase tracking-[0.4em] border-b-2 border-border pb-2 hover:border-black">
          &larr; Back to Home
        </Link>
        <motion.div 
        ...
        >
          <div className="mb-16 text-center lg:text-left">
            <div className="inline-flex items-center gap-3 text-primary font-black uppercase tracking-[0.4em] text-[10px] mb-6">Secured Login</div>
            <h2 className="text-6xl font-black mb-6 tracking-tighter uppercase leading-none text-black">Sign In</h2>
            <p className="text-gray-700 text-xs font-black uppercase tracking-[0.2em] leading-loose">Enter your details and continue your classes.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            >
              LOG IN <ArrowRight size={20} className="group-hover:translate-x-3 transition-transform" />
            </button>
          </form>

          <div className="mt-16 pt-12 border-t-2 border-border border-dashed text-center">
             <p className="text-[10px] text-gray-400 font-bold uppercase tracking-[0.4em] mb-6">New around here?</p>
             <Link href="/register" className="inline-flex items-center gap-4 text-xs font-black text-black hover:text-primary transition-all uppercase tracking-widest border-b-2 border-black pb-1">
